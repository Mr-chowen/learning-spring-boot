...
public class ErrorPageController implements ErrorController{
    ...
    public ErrorPageController(ErrorAttributes attributes) {
        this.attributes = attributes;
    }
    public ErrorPageController() {
        if (errorPageController == null) {
            errorPageController = new ErrorPageController(attributes);
        }
    }
    ...
    protected Map<String, Object> getErrorAttributes(HttpServletRequest request, boolean includeStackTrace) {
        ...
        return this.attributes.getErrorAttributes(webRequest, includeStackTrace);
    }
